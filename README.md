...
Any static server works. From `githublocal`:

```
python -m http.server 4322 --directory extreme-matter-atlas
```
...
[Strange But True Public Source Licence](LICENCE.md): free for personal, educational and
community use with attribution; all commercial rights reserved to Luke Nathan Hayes.
